...
\newcommand{\resheading}[1]{{\large
    \fcolorbox{black}{lightroyalblue}{\begin{minipage}{\textwidth}{\color{white}
...
\resheading{Education}
	\begin{itemize}
		\item
			\ressubheading{\href{http://www.ucla.edu}{University of California Los Angeles}}
                          {Los Angeles, CA}
                          {\href{http://cs.ucla.edu}{Bachelor's in Computer Science}; 
                           \href{}{GPA:--}}{Sep. 2012 -- Present}
				{ \footnotesize
				  \begin{itemize}
					\resitem{Degree expected 2016}
				  \end{itemize}
                }
        \item
            \ressubheading{\href{http://www.sanmarinohs.org}{San Marino High School}}
                          {San Marino, CA}
                          {\href{}{GPA:3.9 (unweighted)}}{Aug. 2008 -- June 2012}
                          { \footnotesize
                            \begin{itemize}
                              \resitem{Graduated with honors and as a Promethean(Salutatorian)}
                            \end{itemize}
                          }
...
\resheading{Experience}
	\begin{itemize}
		\item 
			\ressubheading{{FIRST Team 1160}}{San Marino, CA}{President, Head Programmer}{2008 -- 2012}
				{ \footnotesize
				\begin{itemize}
					\resitem{Built, wired, and programmed a robot to
                      play a new game each year for four years}
					\resitem{Participated and strategized in several
                      regional competitions}
					\resitem{Taught four team members how to program
		...
		\item			
			\ressubheading{San Marino High School Marching Band}{San Marino, CA}{Clarinet Section Leader}{2008 -- 2012}
				{ \footnotesize				
				\begin{itemize}
					\resitem{Led eighteen students in the clarinet
                      section as part of a one hundred student band to
                      create an award winning field show}
					\resitem{Trained section members in musicianship
                      and marching over the course of the 2011
                      football season}
				\end{itemize}
				}
...
\resheading{Projects}
    ...
    \begin{description}
      \item[]{\footnotesize \emph{All code for the following projects can be found on my
        personal website or on my github page.}}
      \item[Team 1160 Scouting App:]
               { \footnotesize An application that collects, processes
                     and displays data at FIRST robotics competitions
      ...
      \item[Blue 'n Gray Wordpress Theme:]
               { \footnotesize A wordpress theme for my blog and my first
                     foray into web design
               }
	  \item[Colorburst Wordpress Theme:]
               { \footnotesize My Second wordpress theme, which is currently in use on my website
               }
		\item[Project Euler Solutions:]
               { \footnotesize My solutions to several programming problems on the
...
\resheading{Skills}
	\begin{description}
		\item[Technologies:] { \footnotesize C/C++, Python, Java,
          Lisp, PHP, HTML, CSS, MSDOS, BASH Scripting, \href{http://www.latex-project.org/}{\LaTeX}, GIT, Bazaar, SVN, XML}
		
        \item[Computer and OS:] { \footnotesize Linux/Unix (Arch Linux), Windows, Mac OS X}
		\item[Software:]{\footnotesize \href{http://netbeans.org}{NetBeans IDE};
