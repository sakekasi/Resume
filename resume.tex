...
\resheading{Skills}
	\begin{description}
		\item[Technologies:] { \footnotesize C/C++, Python, Java,
          Lisp, PHP, HTML, CSS, MSDOS, BASH Scripting,
          \href{http://www.latex-project.org/}{%\LaTeX
          LaTeX}, GIT, Bazaar, SVN, XML}
        ...
        \item[Areas of Interest:] {\footnotesize Data Structures,
			...
			\ressubheading{San Marino High School Marching Band}{San Marino, CA}{Clarinet Section Leader}{2008 -- 2012}
				...
				\begin{itemize}
					\resitem{Led eighteen students in the clarinet
                      section, with a focus on musicianship and
                      marching, as part of a one hundred student band to
